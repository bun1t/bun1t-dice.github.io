        ...
        el.div(
          ...
          el.div(
            ...
            el.div(
              ...
              el.div(
                {className: 'col-xs-8', style:{textAlign:'text-right center'}},
                el.span(
                  {className:'lead', style:{fontWeight:'bold'}},
                  'Client Seed'
                ),
	...
	var innerNode;
      innerNode = el.p(
        {className: 'navbar-text'},
			  ...
			  el.p(null, " ")
			  el.p({className: 'lead'}, "A big thanks go to:"),
			  el.p(null, "Of course to Ryan for creat the Untitled Dice Scipt, J_ROC for helping me to fix thinks and MP to let me run the App"),
